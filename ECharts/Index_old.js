...
$(function () {
	...
	incomeDataUrl = '${fns:getTransDataUrl()}/trans/analysis!queryClever.action?insCd=${fns:getNmgInsIdCd()}&callback=?';
//    alert(dailyTransDataUrl);
//    alert(monthTransDataUrl);

    transAtOptions = {
            
        chart: {
        	renderTo: 'dailyTransAtContainer',
            type: 'line',
            width: 650,
            style : {
...
//            valuePrefix: '$',
    ...
    $.getJSON(dailyTransDataUrl, function (data) {
        ...
        var incomeChart = new Highcharts.Chart(incomeOptions);
    	var transAtChart = new Highcharts.Chart(transAtOptions);
    	var transNumChart = new Highcharts.Chart(transNumOptions);     	
